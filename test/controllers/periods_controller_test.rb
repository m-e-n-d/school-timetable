...
class PeriodsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create period" do
    assert_difference('Period.count') do
      post periods_url, params: { period: { period_num: @period.period_num, subject: @period.subject, user_id: @period.user_id, weekday: @period.weekday } }
    end
  ...
  test "should update period" do
    patch period_url(@period), params: { period: { period_num: @period.period_num, subject: @period.subject, user_id: @period.user_id, weekday: @period.weekday } }
